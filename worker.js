/**
 * I thought of doing hit/edge detection on web worker,
 * it will be fast  and less ui lag
 */
class EdgeDetector {
  /**
   *
...
self.onmessage = (message) => {
  ...
  switch (parsedMsg.type) {
    case 'init':
      edgeDetector = new EdgeDetector(parsedMsg.imageDataArr);
      pristinePixels = edgeDetector.detect();
      break;
  }
};
